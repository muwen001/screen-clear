...
| **解锁中档 HiDPI** | 写 scale-resolutions override 到 `/Library/Displays/Contents/Resources/Overrides/DisplayVendorID-5e3/DisplayProductID-2490`，解锁后 HDMI 重握手生效（可能需重插线缆/重启） | 管理员一次 |
...
├── OverrideInstaller.swift    # osascript 管理员安装/移除
